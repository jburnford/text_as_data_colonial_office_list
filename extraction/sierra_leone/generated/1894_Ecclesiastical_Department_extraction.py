...
OFFICIALS = [
    ...
    {"name": "V. King", "canonical_name": "King, V.", "given_names": "V.", "surname": "King", "position": "Organist", "department": "Ecclesiastical Department - Sierra Leone", "salary_min": 40, "salary_max": 40},
